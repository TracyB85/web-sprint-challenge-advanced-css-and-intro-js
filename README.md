...
1. How would you describe acessibility on the web to someone new to programming?
   Answer: Making sure your website can be accessed by as many people as possible including people with disabilities.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Answer: Using semantic html, checking the colors you use on your site for the color blind and having the ability to use screen readers.
3. How would you explain the concept of a variable to someone new to programming?
   Answer: Anything that can hold data value, basically like a label. Similar to variables in math.
4. What is the purpose of using functions in code?
   Answer: Functions are a set of instructions or tasks encompassed into one line of code.
